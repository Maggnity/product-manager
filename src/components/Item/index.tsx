    ...
    return (
            <div className={styles.lista}>
                ...
                <tr 
                    ...
                    onClick={() => 
                        navigate(`/produto/${id}`)}>
                    <th className={styles.lista__id}>{item.id}</th>
                    <th className={styles.lista__nome}>{item.nome}</th>
                    <th className={styles.lista__marca}>{item.marca}</th>
                    <th className={styles.lista__preco}>$ {item.preco}</th>
                </tr> 
            </div>
    )
}
